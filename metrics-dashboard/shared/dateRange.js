...
export function getLastWeekWorkingDays(reference = new Date()) {
...
export function defaultDateRangeStrings() {
...
export function parseDateParam(value, fallback, endOfDay = false) {
